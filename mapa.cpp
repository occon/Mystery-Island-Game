...
// "  (( " RED"  ((-(-(/(/\\        ''; " BOLDYELLOW "º " RED ".- `      //\\)\\)-)-)) " BOLDYELLOW "   )\n"
// "   )  " RED" (-(-(/(/(/\\      '';;;;-\\~      //\\)\\)\\)-)-)  " BOLDYELLOW " (   )\n"
// "(  (  " RED" ((-(-(/(/(/\\======,:;:;:;:,======/\\)\\)\\)-)-)) " BOLDYELLOW "  )\n"
// "    )  " RED"'(((-(/(/(/(//////:///\\\\\\:\\\\\\)\\)\\)\\)-)))` " BOLDYELLOW " ( (\n"
...
void isFenixHere(string mapa[][8],int Col, int Ren, Personaje* player){
    ...
    if (mapa[5][6] == character && player->getMascota()==0){
        ...
        if (resp==1){
            ...
            cout << endl << "Has agarrado un fenix y te ha regenarado 20 de vida. Ahora tienes " << player->getHP() << " de vida." << endl;
            system("pause");
        }
        else{
...
void ganarCofre(string mapa[][8],int Col, int Ren, Personaje* player, Items* llave){
    if (mapa[0][7] == character && llave->getDisponibilidad()==0){
        ...
        cout<<"           \'.   ||:::::.-!"<<CYAN "@"<<YELLOW "oo "<< MAGENTA"@" << YELLOW "ooºo"<< MAGENTA "@" <<YELLOW "oº"<<RESET <<"'_.|"<< endl;
        cout<<"            '.'-;|:.-'"<<YELLOW ".oºo" RESET <<MAGENTA "@" RESET<< YELLOW"oººOºo"<<CYAN"@"<< YELLOW "ºo" RESET<<".'\\  ||"<< endl;
        cout<<"                `>'-."""<<YELLOW"oººoO" RESET <<MAGENTA "@" YELLOW "ºo"<<MAGENTA" @" RESET<<"'.-"<< YELLOW "o" RESET <<"_.|'|"<< endl;
        cout<<"                ||-.'-..-'_.-' _.-"<< YELLOW "o" RESET <<"  |'||"<< endl;
